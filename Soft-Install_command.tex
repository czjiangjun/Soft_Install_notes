...
\begin{itemize}
	...
	\item \textrm{cmake ../cmake -D BUILD\_SHARED\_LIBS=yes -D LAMMPS\_EXCEPTIONS=yes  -D PKG\_MANYBODY=yes -D PKG\_PYTHON=yes -D PKG\_RIGID=yes -D PKG\_MOLUCULE=yes -D PKG\_KSPACE=yes -D PKG\_MISC=yes -D PKG\_MC=yes -D PYTHON\_EXECUTABLE=yes}
